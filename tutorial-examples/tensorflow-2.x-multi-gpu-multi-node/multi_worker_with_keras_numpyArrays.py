...
#strategy definition moved to top of notebook 
...
for i in range(50):
    x_big_train = np.vstack((x_big_train,x_train))
    y_big_train = np.concatenate((y_big_train,y_train))
...
print(x_big_train.shape,y_big_train.shape)
...
GLOBAL_BATCH_SIZE =  30000* NUM_WORKERS
with strategy.scope():
...
multi_worker_model.fit(x=x_big_train, y=y_big_train, 
